...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      <h1 className="section-heading seq mt-2">کارهای من</h1>
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2">
      .من در بیش از ۲۰ پروژه مختلف مشارکت کرده‌ام که شامل توسعه فرانت‌اند، طراحی UI/UX، پروژه‌های متن‌باز و موشن گرافیک می‌شود و پروژه‌هایی در گیت‌هاب دارم.
      </h2>
    </div>
  );
