...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        .من یک تکنسین کامپیوتر هستم و کار طراحی و توسعه وب‌سایت انجام می‌دهم{" "}
      </span>
      <span
      ...
      >
        .من مسئولیت طراحی یک سایت خوب را با استفاده از معماری فرانت‌اند مدرن بر عهده می‌گیرم
      </span>
    </h1>
  );
